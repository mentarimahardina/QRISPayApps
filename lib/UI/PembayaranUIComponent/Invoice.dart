import 'package:QRISPayApps/UI/PembayaranUIComponent/receipt.dart';
...
class InvoicePage extends StatefulWidget {
  // InvoicePage({Key key, this.title, this.data}) : super(key: key);

  InvoicePage(this.data);
  final String data;

  @override
  _InvoicePageState createState() => _InvoicePageState(this.data);
}
...
class _InvoicePageState extends State<InvoicePage> {
        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Text(
                tokonama.toUpperCase() + " ," + tokocity.toUpperCase(),
  ...
  void bayar() async {
    setState(() {
      databayar =
          data + "," + ctrlmoney.text.toString() + "," + _metode.toString();
    }); // Navigator.of(context).pop(databayar);
    Navigator.of(context).push(PageRouteBuilder(
        pageBuilder: (_, __, ___) => new ReceiptPage(databayar),
